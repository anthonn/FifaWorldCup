        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GroupLetter = table.Column<string>(type: "character varying(1)", maxLength: 1, nullable: false),
                    FlagUrl = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GroupLetter = table.Column<string>(type: "character varying(1)", maxLength: 1, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Stage = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    SelectedWinnerTeamId = table.Column<int>(type: "integer", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP"),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Bets_Teams_SelectedWinnerTeamId",
                        column: x => x.SelectedWinnerTeamId,
                        principalTable: "Teams",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserPredictions_Matches_MatchId",
                        column: x => x.MatchId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bets_SelectedWinnerTeamId",
                table: "Bets",
                column: "SelectedWinnerTeamId");

            migrationBuilder.CreateIndex(
                name: "IX_Bets_UserId_Stage",
                table: "Bets",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TournamentStages_Name",
                table: "TournamentStages",
                column: "Name",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_UserPredictions_MatchId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserPredictions_UserId_MatchId",
                table: "UserPredictions",
